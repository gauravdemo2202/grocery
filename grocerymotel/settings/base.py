...
STRIPE_PUBLISHABLE = os.environ.get('STRIPE_PUBLISHABLE_KEY') if os.environ.get('STRIPE_PUBLISHABLE_KEY') else ''
STRIPE_SECRET = os.environ.get('STRIPE_SECRET_KEY') if os.environ.get('STRIPE_SECRET_KEY') else ''
